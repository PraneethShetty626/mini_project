            ...
            <section className="w-full body-font">
                <div className="container px-5 mx-auto">
                    <div className="text-center">
                        <h1 className="rounded-lg bg-yellow-200 mt-2 sm:text-3xl text-2xl font-medium text-center title-font text-blue-900">{name} <br></br><span className="text-[20px]">License No - {complicense}</span><br></br><p className="text-center text-base leading-relaxed">{id}</p></h1>
                    </div>
