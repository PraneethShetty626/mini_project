    ...
    return (
      <div className="container-owner">
        <div className="mb-5 row mt-2" style={{ display: "flex", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <div className="m-3" />
          <center>
          <div className="col mt-2 rounded-md py-4  bg-green-400"  >
          ...
          <div className="col pt-4 w-full rounded-md bg-violet-300 pb-4" >
            ...
            <div>
              <form className="font-bold" onSubmit={this.addUserByAdhaar}>
                ...
                <input type="text" className="py-1 px-1 rounded-full w-70" id="user_name" placeholder="Name"></input>
                <br></br>
                <br></br>
                <div className="label mt-2">Blockchain Address:</div>
                <input type="text" className="py-1 px-1 rounded-full w-70" id="adhaar_blockchain_id" placeholder="Blockchain Id"></input>
                <br></br>
                <br></br>
                <div className="label mt-2">Adhaar number:</div>
                <input type="text" className="py-1 px-1 rounded-full w-70" id="adhaar_number" placeholder="Adhaar"></input>
                <br></br>
                <br></br>
                <div className="label mt-2">DOB:</div>
                <input type="text" className="py-1 px-1 rounded-full w-70" id="dob" placeholder="DD/MM/YYYY"></input>
                <br></br>
                <br></br>
                <div className="label mt-2">pincode:</div>
                <input type="text" className="py-1 px-1 rounded-full w-70" id="pincode" placeholder="pincode"></input>
                <br></br>
                <br/>
                <br></br>
                <button class="py-2 pb-8 px-4  text-pink-100 transition-colors duration-50 bg-pink-600 rounded-full hover:bg-blue-700" type="submit">
                  ADD to EHR
                </button>
              </form>
            </div>
