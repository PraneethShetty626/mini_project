            ...
            <div className='container' >
                <div>
                    <div class="rounded-[20px] text-center w-full">
                        <h1 class="rounded-lg bg-[#7C3AED] mt-2 sm:text-3xl text-2xl font-medium text-center title-font text-white">{name} <br></br><span className="text-[20px]">DOB - {DOB}</span><br></br><p class="text-center text-white text-[20px] leading-relaxed">{contact_info}</p>
                        </h1>
                    </div>
